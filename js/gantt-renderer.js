...
const GanttRenderer = (function () {
    ...
    function loadCollapsedState() {
        const stored = localStorage.getItem('gantt_collapsed_evals_1cfgs');
        if (stored) {
            try {
    ...
    function saveCollapsedState() {
        localStorage.setItem('gantt_collapsed_evals_1cfgs', JSON.stringify(state.collapsedEvals));
    }

    function loadFiltersState() {
        const stored = localStorage.getItem('gantt_filters_1cfgs');
        if (stored) {
            try {
    ...
    function saveFiltersState() {
        localStorage.setItem('gantt_filters_1cfgs', JSON.stringify({
