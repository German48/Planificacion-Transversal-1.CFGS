...
const ProgressTracker = {
     ...
     */
    setDailyTask(date, taskId, completed, module = 'DRP') {
    ...
    getDailyTask(date, taskId, module = 'DRP') {
        const key = this.getTrackingKey(date, module);
     ...
     */
    setWeeklyDod(weekId, dodId, completed, module = 'DRP') {
    ...
    getWeeklyDod(weekId, dodId, module = 'DRP') {
        const key = this.getTrackingKey(weekId, module);
     ...
     * @param {string} module - Módulo (DRP, RRC, etc.)
    ...
    getStatsFiltered(selectionResolver = null) {
        ...
        Object.entries(this.state.dailyTasks).forEach(([key, tasks]) => {
            Object.values(tasks).forEach(task => {
                const moduleId = task.module || 'DRP';
